...
function OrionLib:MakeWindow(WindowConfig)
	...
	-- Set functions
		...
		function TabFunction:SetBackground(URL)
    		...
    		if MainWindow:FindFirstChild("CustomBackground") then
        		MainWindow.CustomBackground:Destroy()
    		end
    		...
    		bg.ZIndex = 0
    		bg.ImageTransparency = WindowConfig.BackgroundTransparency or 0.2
		...
		function TabFunction:SetBackgroundTransparency(Transparency)
    		...
    		local bg = MainWindow:FindFirstChild("CustomBackground")
    		if bg then
        		bg.ImageTransparency = WindowConfig.BackgroundTransparency
    		end
		end
		...
		function TabFunction:SetBackgroundVisibility(Bool)
    		...
    		if not Bool then
        		MainWindow.BackgroundTransparency = WindowConfig.Transparency or 0.35
    		else
        		MainWindow.BackgroundTransparency = 1
    		end
		end
