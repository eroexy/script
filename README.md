...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		NotificationConfig.Image = NotificationConfig.Image or "rbxassetid://10709775560"
...
function OrionLib:MakeWindow(WindowConfig)
	...
	if WindowConfig.ShowIcon then
		...
		WindowIcon.ImageColor3 = Color3.fromRGB(OrionLib.Themes[OrionLib.SelectedTheme].Text.R, OrionLib.Themes[OrionLib.SelectedTheme].Text.G , OrionLib.Themes[OrionLib.SelectedTheme].Text.B)
